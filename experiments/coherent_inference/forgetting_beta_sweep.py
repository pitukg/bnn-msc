...
# Pretrain
factory.BETA = args.beta
bnn.BETA = args.beta
pretrain_experiment = factory.mfvi(bnn, pretrain_data)
...
axs[0].set_title(f"Prior learnt via VI with beta={args.beta}")
...
fig.savefig(f"figs/forgetting_beta_{args.beta}_{args.factory}_{args.D_X}.pdf")
